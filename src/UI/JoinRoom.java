...
public class JoinRoom extends javax.swing.JFrame {
    ...
    public JoinRoom() {
       ...
       /* task.setOnRefreshListner(new Ask4Roominfo.OnRefreshListener() {
            ...
            public void onRefresh(String test) {
                ...
                roomstatus = task.Get_roomstatus();
                if (roomstatus == 2) {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/img/QuitRoom.jpg"))); // NOI18N
        ...
        jButton1.setBounds(560, 380, 176, 41);
        ...
        jScrollPane1.setBounds(30, 190, 452, 190);
